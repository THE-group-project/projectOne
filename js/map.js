...
const markerImages = {
  'Burger' : 'css/images/food-icon-burger.png',
  'Beer' : 'css/images/food-icon-beer.png',
  'Coffee' : 'css/images/food-icon-coffee.png',  
  'All' : 'css/images/food-icon-4.png'
}
...
function getMarkerIcon(){
  ...
  return 'css/images/food-icon-5.png';
}
